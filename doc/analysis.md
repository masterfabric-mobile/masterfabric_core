...
> **Superseded:** For the current Flutter 3.44 / Dart 3.12 sync gap (parity, weaknesses, dependency matrix), see [sync_gap_flutter_344.md](sync_gap_flutter_344.md). This document remains as a December 2025 historical snapshot of OSMEA `packages/core`.
